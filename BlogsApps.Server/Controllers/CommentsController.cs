...
namespace BlogsApps.Server.Controllers
{
    ...
    public class CommentsController : ControllerBase
    {
        ...
        public CommentsController(ModelsDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Comments>> PostComments(Comments comments)
        {
            ...
            return CreatedAtAction("GetComments", new { id = comments.ComentsId }, comments);
        }
        ...
        {
            return _context.Comments.Any(e => e.ComentsId == id);
        }
    }
}
